...
const IdeasSomebodyAlreadyMadePage: FC = () => {
	return (
		<Container maxWidth="md">
			...
			<Stack gap={4}>
				<Typography>
					You know how you have a great idea, and you start googling around, maybe even
					start making it, creating a repo, spending hours and days on it and then you
					suddenly stumble over a repo of somebody else who did exactly the same thing as
					you wanted?
				</Typography>
				...
				<section>
					...
					<Typography>
						...
						latest book,{" "}
						<JoyLink href="https://xkcd.com/what-if-2/">what if? 2</JoyLink>.
					</Typography>
					<Typography>
						Now, I bought the book and came across the list in the book and found it
						very amusing to have a list like that on here. I would need to think about
						where to get more entries from, maybe there are more pieces online?..
					</Typography>
					<Typography>
						6th link in google:{" "}
					...
					<Typography>
						Of course somebody already made AI-generated, every-day-updated version of
						this very list.
					</Typography>
				</section>
				...
				<section>
					...
					<Typography>
						So every time you add a new client (like new PC/laptop/phone for yourself or
						a friend), you would generate a pair of keys and write a config and send
						that to the friend. (and also a similar but much smaller [Peer]
						configuration that you would save in server&apos;s config.
					</Typography>
					<Typography>
						After you do that 10 times in a row, you would want to have a handy tool to
						automate most of the job. The tool will run on the server, so it would be a
						CLI app, and can be small and quick. Great choice for a Golang application.
						Also there is this cli-gui-interface library,{" "}
						<JoyLink href="https://github.com/charmbracelet/bubbletea">
							Bubble tea
						</JoyLink>
