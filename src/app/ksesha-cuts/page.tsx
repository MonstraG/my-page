				...
				<div className={styles.workplaceContainer}>
					...
					<div>
						...
						<p className={styles.secondary}>
							Worked as a pet groomer, with 157 out of 162 five-star reviews.
							Specialized in hand stripping and cats. Started giving grooming lessons
							on behalf of the company. I&apos;ve taught stripping to 20+ students.
							Supervised short-term internship of 50+ students.
						</p>
					</div>
				</div>
				<div className={styles.workplaceContainer}>
