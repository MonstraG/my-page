...
const D2: FC = () => (
	<DieBaseSvg className={styles.d2}>
		<circle cx="20" cy="20" r="20" />
	</DieBaseSvg>
);

const D4: FC = () => (
	<DieBaseSvg className={styles.d4}>
		<path d="M40 37.4H0L20 2.7z" />
	</DieBaseSvg>
);

const D6: FC = () => (
	<DieBaseSvg className={styles.d6}>
		<path d="M0 0h40v40H0z" />
	</DieBaseSvg>
);

const D8: FC = () => (
	<DieBaseSvg className={styles.d8}>
		<path d="M20 40L0 20 20 0l20 20z" />
	</DieBaseSvg>
);

const D10: FC = () => (
	<DieBaseSvg className={styles.d10}>
		<path d="M20 0L0 16.9v6.3L20 40l20-16.9V17z" />
	</DieBaseSvg>
);

const D12: FC = () => (
	<DieBaseSvg className={styles.d12}>
		<path d="M20 40L0 24.8 7.6 0h24.7L40 24.8z" />
	</DieBaseSvg>
);

const D20: FC = () => (
	<DieBaseSvg className={styles.d20}>
