...
const unparsedSpells: UnparsedSpell[] = [
	...
	},
	{
		...
		components: "VSM",
		tags: ["Utility"],
		castingTime: { value: 24, unit: "hour" },
		description:
	...
	},
	{
		...
		components: "VSM",
		tags: ["Utility"],
		castingTime: { value: 12, unit: "hour" },
		description:
